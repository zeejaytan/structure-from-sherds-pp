...
restore() { sed -i 's|^#define POT_A_ORIG\b|// #define POT_A_ORIG|; s|^\/\/ *#define JUGLET\b|#define JUGLET|' class/data_path.h; }
trap restore EXIT
grep -nE '^\s*#define (JUGLET|POT_A_ORIG)\b' class/data_path.h
