...
public:
	...
	bool ground_ = false;		// 'g' key : Save transformation matrix
	bool fine_ = false;			// 'f' key : Perform fine registration
	bool is_fine_ = false;		// Did this solution perform fine reconstruction?
